...
import dev.randykinne.me.config.ApplicationProperties
...
class KotlintestApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes kotlintest.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<KotlintestApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(KotlintestApp::class.java)
